...
class Main(object):
	def __init__(self):
		...
		self.softLinkList = (
			(os.path.join(self.scriptPath, 'hello-android.h'),
				os.path.join(self.androidScPath, 'hardware', 'libhardware', 'include', 'hardware', 'hello-android.h')
				),
			(self.scriptPath,
				os.path.join(self.androidScPath, 'hardware', 'libhardware', 'modules', 'hello-android')
				),
			)
